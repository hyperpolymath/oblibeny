...
```
┌───────────────────────────────────────────────────────────┐
│ APPROACH A: Top-Down (Alpine)                            │
├───────────────────────────────────────────────────────────┤
│                                                           │
│  Alpine Linux (14,000 packages)                          │
│      ↓                                                    │
│  Remove: systemd, perl, python, ...                      │
│      ↓                                                    │
│  Still have: 5,000+ files                                │
│      ↓                                                    │
│  Attack surface: LARGE                                   │
│  Maintenance: Inherit Alpine's problems                  │
│  Formal verification: IMPOSSIBLE (too much legacy)       │
│                                                           │
└───────────────────────────────────────────────────────────┘

┌───────────────────────────────────────────────────────────┐
│ APPROACH B: Bottom-Up (Distroless) ✅                    │
├───────────────────────────────────────────────────────────┤
│                                                           │
│  Distroless (20 files)                                   │
│      ↓                                                    │
│  Add: obli-pkg (proven necessary)                        │
│      ↓                                                    │
│  Add: curl (proven necessary)                            │
│      ↓                                                    │
│  Total: ~50 files                                        │
│      ↓                                                    │
│  Attack surface: MINIMAL                                 │
│  Maintenance: Only what you added                        │
│  Formal verification: FEASIBLE (small, intentional)      │
│                                                           │
└───────────────────────────────────────────────────────────┘
```
...
**You say:** "Here's the Idris2 proof it's necessary." ✅
...
✅ **Smaller attack surface** (~50 files vs ~2,000)
✅ **Less maintenance** (only YOUR components)
✅ **Formal verification feasible** (small enough to verify)
✅ **No inherited technical debt** (start fresh)
✅ **Intentional design** (every file justified)
✅ **Security by default** (restrictive, not permissive)

**The math is clear:**
```
Alpine top-down:  5,000 files → 2,000 files (60% reduction)
Distroless bottom-up:  20 files →   50 files (2.5x increase)

Final ratio: 2,000 / 50 = 40× MORE files with Alpine approach
```
...
**Result:** Minimal, maintainable, formally verified distribution. 🛡️
