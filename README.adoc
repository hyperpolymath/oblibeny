...
image:https://img.shields.io/badge/License-MPL--2.0-indigo.svg[License: MPL-2.0,link="https://github.com/hyperpolymath/palimpsest-license"]
image:https://img.shields.io/badge/Status-Active--Development-blue.svg[Status: Active Development]
...
|*Static Analyzer*
|Partial
|Resource and reversibility analysis exists; call analysis and structure-size accounting remain incomplete.
...
|*Debugger*
|Scaffold / partial
|Checkpoint and inverse-operation helpers exist. Forward stepping does not execute statements or update variables; continue is unimplemented.

|*Profiler*
|Partial
|Reporting structures exist; call counts and execution time include placeholders and are not runtime measurements.
...
|Container/deployment configuration exists. This table does not establish a verified deployed compiler/runtime or close the crypto/package verification gaps above.
|===
...
|Status
|Active development (see .machine_readable/descriptiles/STATE.a2ml)
...
See link:.github/CONTRIBUTING.md[.github/CONTRIBUTING.md] for development guidelines.
